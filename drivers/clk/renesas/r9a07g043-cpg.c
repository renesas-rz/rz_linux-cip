...
static const struct cpg_core_clk r9a07g043_core_clks[] __initconst = {
	...
	DEF_FIXED("M1", R9A07G043_CLK_M1, CLK_PLL5, 1, 1),
	...
	DEF_2DIV("M3", R9A07G043_CLK_M3, CLK_SEL_PLL5_4,
		...
		CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("M4", R9A07G043_CLK_M4, CLK_PLL2_FOUT3_DIV2,
	...
	DEF_DIV("G", R9A07G043_CLK_G, CLK_SEL_GPU2, DIVGPU, dtable_1_8,
		CLK_DIVIDER_HIWORD_MASK),
};
...
static struct rzg2l_mod_clk r9a07g043_mod_clks[] = {
	...
	DEF_MOD("ia55_pclk",	R9A07G043_IA55_PCLK, R9A07G043_CLK_P2,
				0x518, 0, MSTOP(PERI_CPU_MSTOP, BIT(13))),
	...
	DEF_MOD("dmac_pclk",	R9A07G043_DMAC_PCLK, CLK_P1_DIV2,
				0x52c, 1, MSTOP(REG1_MSTOP, BIT(2) | BIT(3))),
	DEF_MOD("spi_clk2",	R9A07G043_SPI_CLK2, R9A07G043_CLK_SPI1,
				0x550, 0, MSTOP(MCPU1_MSTOP, BIT(1))),
	...
	DEF_MOD("sdhi1_imclk2",	R9A07G043_SDHI1_IMCLK2, CLK_SD1_DIV4,
				0x554, 5, MSTOP(PERI_COM_MSTOP, BIT(1))),
	DEF_MOD("sdhi1_clk_hs",	R9A07G043_SDHI1_CLK_HS, R9A07G043_CLK_SD1,
				0x554, 6, MSTOP(PERI_COM_MSTOP, BIT(1))),
	DEF_MOD("sdhi1_aclk",	R9A07G043_SDHI1_ACLK, R9A07G043_CLK_P1,
				0x554, 7, MSTOP(PERI_COM_MSTOP, BIT(1))),
	...
	DEF_MOD("ssi1_sfr",	R9A07G043_SSI1_PCLK_SFR, R9A07G043_CLK_P0,
				0x570, 3, MSTOP(MCPU1_MSTOP, BIT(11))),
	...
	DEF_MOD("ssi2_sfr",	R9A07G043_SSI2_PCLK_SFR, R9A07G043_CLK_P0,
				0x570, 5, MSTOP(MCPU1_MSTOP, BIT(12))),
	...
	DEF_MOD("adc_pclk",	R9A07G043_ADC_PCLK, R9A07G043_CLK_P0,
				0x5a8, 1, MSTOP(MCPU2_MSTOP, BIT(14))),
	...
	DEF_MOD("tsu",		R9A07G043_TSU_PCLK, R9A07G043_CLK_TSU,
				0x5ac, 0, MSTOP(MCPU2_MSTOP, BIT(15))),
	DEF_MOD("poe3",		R9A07G043_POE3_CLKM_POE, R9A07G043_CLK_P0,
				0x53c, 0, MSTOP(MCPU1_MSTOP, BIT(9))),
	DEF_MOD("cru_sysclk",	R9A07G043_CRU_SYSCLK, CLK_PLL3_533_DIV4,
				0x564, 0, MSTOP(PERI_VIDEO_MSTOP, BIT(3))),
	DEF_MOD("cru_vclk",	R9A07G043_CRU_VCLK, R9A07G043_CLK_M2,
				0x564, 1, MSTOP(PERI_VIDEO_MSTOP, BIT(3))),
	...
	DEF_MOD("cru_aclk",	R9A07G043_CRU_ACLK, R9A07G043_CLK_M0,
				0x564, 3, MSTOP(PERI_VIDEO_MSTOP, BIT(3))),
	...
	DEF_MOD("lcdc_clkd",	R9A07G043_LCDC_CLK_D, R9A07G043_CLK_M3,
				0x56C, 1, MSTOP(PERI_VIDEO_MSTOP,
						BIT(7) | BIT(8) | BIT(9))),
};
...
static struct rzg2l_reset r9a07g043_resets[] = {
	...
	DEF_RST(R9A07G043_SRC_RST, 0x874, 0),
...
const struct rzg2l_cpg_info r9a07g043_cpg_info = {
	...
	.num_resets = ARRAY_SIZE(r9a07g043_resets),
};
