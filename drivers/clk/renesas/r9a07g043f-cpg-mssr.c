...
static const struct cpg_core_clk r9a07g043f_core_clks[] __initconst = {
	...
	DEF_FIXED("M2_DIV2", CLK_M2_DIV2, R9A07G043F_CLK_M2, 1, 2),
	...
	DEF_MUX("HP", R9A07G043F_CLK_HP, SEL_ETH,
...
static struct mssr_mod_clk r9a07g043f_mod_clks[] = { 
	DEF_MOD("pldm", 	R9A07G043F_CLK_NCEPLDM, 
				CLK_SEL_PLL3_1, 
				MSSR((0x100 >> 2), BIT(1), (BIT(1) | BIT(0)))),
	DEF_MOD("plmt",		R9A07G043F_CLK_NCEPLMT, 
				CLK_XINCLK,
				MSSR((0x104 >> 2), BIT(0), (BIT(1) | BIT(0)))),
	DEF_MOD("plic",		R9A07G043F_CLK_NCEPLIC, 
				CLK_SEL_PLL3_1,
				MSSR((0x108 >> 2), BIT(0), BIT(0))),
	DEF_MOD("ax45mp",	R9A07G043F_CLK_AX45MP,
				CLK_SEL_PLL3_1, 
				MSSR((0xF8 >> 2), (BIT(1) | BIT(0)), \
	 ...
	 DEF_MOD("dmac",	R9A07G043F_CLK_DMAC,
	 			...
	 			MSSR(11, (BIT(0) | BIT(1)),
	 				 (BIT(0) | BIT(1)))),
	 DEF_MOD("sysc",	R9A07G043F_CLK_SYSC,
	 			CLK_XINCLK,
	 			MSSR(12, (BIT(0) | BIT(1)),
	 				 (BIT(0) | BIT(1) | BIT(2)))),
	 ...
	 DEF_MOD("mhu",		R9A07G043F_CLK_MHU,
	 			R9A07G043F_CLK_P1,
	 			MSSR(8, BIT(0), BIT(0))),
...
static const unsigned int r9a07g043f_crit_mod_clks[] __initconst = {
	CLK_MODE_BASE + R9A07G043F_CLK_NCEPLIC,
};
...
const struct cpg_mssr_info r9a07g043f_cpg_info = {
	...
	.num_hw_mod_clks = R9A07G043F_CLK_CSI2 + 1,
};
