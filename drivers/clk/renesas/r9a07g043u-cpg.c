...
static const struct cpg_core_clk r9a07g043u_core_clks[] __initconst = {
	...
	DEF_MUX("SD1", R9A07G043U_CLK_SD1, SEL_SDHI1,
			sel_shdi, 4, CLK_MUX_HIWORD_MASK),
	DEF_FIXED("SD0_DIV4", CLK_SD0_DIV4, R9A07G043U_CLK_SD0, 1, 4),
	DEF_FIXED("SD1_DIV4", CLK_SD1_DIV4, R9A07G043U_CLK_SD1, 1, 4),
	...
	DEF_FIXED("M2_DIV2", CLK_M2_DIV2, R9A07G043U_CLK_M2, 1, 2),
	...
	DEF_MUX("HP", R9A07G043U_CLK_HP, SEL_ETH,
...
static const unsigned int r9a07g043u_crit_mod_clks[] __initconst = {
	...
	CLK_MODE_BASE + R9A07G043U_CLK_IA55,
	CLK_MODE_BASE + R9A07G043U_CLK_DMAC,
	CLK_MODE_BASE + R9A07G043U_CLK_SYSC,
	CLK_MODE_BASE + R9A07G043U_CLK_SYC,
};
