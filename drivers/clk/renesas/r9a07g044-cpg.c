...
static const struct {
	...
	.common = {
		...
		DEF_MOD("wdt1_pclk",	R9A07G044_WDT1_PCLK, R9A07G044_CLK_P0,
					0x548, 2, MSTOP(REG0_MSTOP, BIT(3))),
		...
		DEF_MOD("dsi_lpclk",	R9A07G044_MIPI_DSI_LPCLK, R9A07G044_CLK_M4,
					0x568, 5, MSTOP(PERI_VIDEO_MSTOP,
							BIT(5) | BIT(6))),
