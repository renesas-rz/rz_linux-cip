...
static const struct rzg2l_cpg_pm_domain_init_data r9a07g044_pm_domains[] = {
	...
	DEF_PD("ia55",		R9A07G044_PD_IA55,
				...
				GENPD_FLAG_ALWAYS_ON),
	DEF_PD("dmac",		R9A07G044_PD_DMAC,
				DEF_REG_CONF(CPG_BUS_REG1_MSTOP,
				GENMASK(3, 0)),
				GENPD_FLAG_ALWAYS_ON),
	DEF_PD("ostm0",		R9A07G044_PD_GTM0,
				DEF_REG_CONF(CPG_BUS_REG0_MSTOP, BIT(4)),
				GENPD_FLAG_ALWAYS_ON),
	DEF_PD("ostm1",		R9A07G044_PD_GTM1,
				DEF_REG_CONF(CPG_BUS_REG0_MSTOP, BIT(5)),
				GENPD_FLAG_ALWAYS_ON),
	DEF_PD("ostm2",		R9A07G044_PD_GTM2,
				DEF_REG_CONF(CPG_BUS_REG0_MSTOP, BIT(6)),
				GENPD_FLAG_ALWAYS_ON),
	DEF_PD("mtu",		R9A07G044_PD_MTU,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(2)), 0),
	DEF_PD("poe3",		R9A07G044_PD_POE3,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(9)), 0),
	DEF_PD("gpt",		R9A07G044_PD_GPT,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(4)), 0),
	DEF_PD("poega",		R9A07G044_PD_POEGA,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(5)), 0),
	DEF_PD("poegb",		R9A07G044_PD_POEGB,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(6)), 0),
	DEF_PD("poegc",		R9A07G044_PD_POEGC,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(7)), 0),
	DEF_PD("poegd",		R9A07G044_PD_POEGD,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(8)), 0),
	DEF_PD("wdt0",		R9A07G044_PD_WDT0,
				DEF_REG_CONF(CPG_BUS_REG0_MSTOP, BIT(2)), 0),
	DEF_PD("wdt1",		R9A07G044_PD_WDT1,
				DEF_REG_CONF(CPG_BUS_REG0_MSTOP, BIT(3)), 0),
	DEF_PD("wdt2",		R9A07G044_PD_WDT2,
				DEF_REG_CONF(CPG_BUS_REG0_MSTOP, BIT(1)), 0),
	DEF_PD("spi",		R9A07G044_PD_SPI,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(1)), 0),
	DEF_PD("sdhi0",		R9A07G044_PD_SDHI0,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, BIT(0)), 0),
	DEF_PD("sdhi1",		R9A07G044_PD_SDHI1,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, BIT(1)), 0),
	DEF_PD("isu",		R9A07G044_PD_ISU,
				DEF_REG_CONF(CPG_BUS_PERI_VIDEO_MSTOP, BIT(4)), 0),
	DEF_PD("h264",		R9A07G044_PD_VCPL4,
				DEF_REG_CONF(CPG_BUS_PERI_VIDEO_MSTOP,
				GENMASK(2, 0)), 0),
	DEF_PD("cru",		R9A07G044_PD_CRU,
				DEF_REG_CONF(CPG_BUS_PERI_VIDEO_MSTOP, BIT(3)), 0),
	DEF_PD("dsi",		R9A07G044_PD_MIPI_DSI,
				DEF_REG_CONF(CPG_BUS_PERI_VIDEO_MSTOP,
				GENMASK(6, 5)), 0),
	DEF_PD("lcdc",		R9A07G044_PD_LCDC,
				DEF_REG_CONF(CPG_BUS_PERI_VIDEO_MSTOP,
				GENMASK(9, 7)), 0),
	DEF_PD("ssi0",		R9A07G044_PD_SSI0,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(10)), 0),
	DEF_PD("ssi1",		R9A07G044_PD_SSI1,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(11)), 0),
	DEF_PD("ssi2",		R9A07G044_PD_SSI2,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(12)), 0),
	DEF_PD("ssi3",		R9A07G044_PD_SSI3,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(13)), 0),
	DEF_PD("src",		R9A07G044_PD_SRC,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(3)), 0),
	DEF_PD("usb-phy",	R9A07G044_PD_USB_PHY,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, BIT(4)), 0),
	DEF_PD("usb0",		R9A07G044_PD_USB0,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, GENMASK(6, 5)), 0),
	DEF_PD("usb1",		R9A07G044_PD_USB1,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, BIT(7)), 0),
	DEF_PD("eth0",		R9A07G044_PD_ETHER0,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, BIT(2)), 0),
	DEF_PD("eth1",		R9A07G044_PD_ETHER1,
				DEF_REG_CONF(CPG_BUS_PERI_COM_MSTOP, BIT(3)), 0),
	DEF_PD("i2c0",		R9A07G044_PD_I2C0,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(10)), 0),
	DEF_PD("i2c1",		R9A07G044_PD_I2C1,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(11)), 0),
	DEF_PD("i2c2",		R9A07G044_PD_I2C2,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(12)), 0),
	DEF_PD("i2c3",		R9A07G044_PD_I2C3,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(13)), 0),
	DEF_PD("scif0",		R9A07G044_PD_SCIF0,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(1)), 0),
	DEF_PD("scif1",		R9A07G044_PD_SCIF1,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(2)), 0),
	DEF_PD("scif2",		R9A07G044_PD_SCIF2,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(3)), 0),
	DEF_PD("scif3",		R9A07G044_PD_SCIF3,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(4)), 0),
	DEF_PD("scif4",		R9A07G044_PD_SCIF4,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(5)), 0),
	DEF_PD("sci0",		R9A07G044_PD_SCI0,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(7)), 0),
	DEF_PD("sci1",		R9A07G044_PD_SCI1,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(8)), 0),
	DEF_PD("rspi0",		R9A07G044_PD_RSPI0,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(14)), 0),
	DEF_PD("rspi1",		R9A07G044_PD_RSPI1,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(15)), 0),
	DEF_PD("rspi2",		R9A07G044_PD_RSPI2,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(0)), 0),
	DEF_PD("canfd",		R9A07G044_PD_CANFD,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(9)), 0),
	DEF_PD("adc",		R9A07G044_PD_ADC,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(14)), 0),
	DEF_PD("tsu",		R9A07G044_PD_TSU,
