...
static const struct {
	struct rzg2l_mod_clk common[84];
#ifdef CONFIG_CLK_R9A07G054
	...
	.common = {
		...
		DEF_MOD("isu_pclk",     R9A07G044_ISU_PCLK, R9A07G044_CLK_P2,
					0x55C, 1, 0),
		DEF_COUPLED("h264_clk_a", R9A07G044_H264_CLK_A, R9A07G044_CLK_M0,
					0x560, 0, 0),
		DEF_COUPLED("h264_clk_p", R9A07G044_H264_CLK_P, R9A07G044_CLK_ZT,
					0x560, 0, 0),
