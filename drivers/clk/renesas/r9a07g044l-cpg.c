...
static const struct cpg_core_clk r9a07g044l_early_core_clks[] __initconst = {
...
static struct mssr_mod_clk r9a07g044l_early_mod_clks[] = {
...
const struct cpg_mssr_info r9a07g044l_cpg_info = {
	/* Early clk */
	.early_core_clks = r9a07g044l_early_core_clks,
	.num_early_core_clks = ARRAY_SIZE(r9a07g044l_early_core_clks),
	.early_mod_clks = r9a07g044l_early_mod_clks,
	.num_early_mod_clks = ARRAY_SIZE(r9a07g044l_early_mod_clks),
	/* Core clk */
...
static void __init r9a07g044l_cpg_early_init(struct device_node *np)
{
	rzg2l_cpg_early_init(np, &r9a07g044l_cpg_info);
}

CLK_OF_DECLARE_DRIVER(cpg_mstp_clks, "renesas,r9a07g044l-cpg",
		      r9a07g044l_cpg_early_init);
