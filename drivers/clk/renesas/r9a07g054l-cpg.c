...
static const struct cpg_core_clk r9a07g054l_core_clks[] __initconst = {
	...
	DEF_MUX("SD1", R9A07G054L_CLK_SD1, SEL_SDHI1,
			sel_shdi, 4, CLK_MUX_HIWORD_MASK),
	DEF_FIXED("SD0_DIV4", CLK_SD0_DIV4, R9A07G054L_CLK_SD0, 1, 4),
	DEF_FIXED("SD1_DIV4", CLK_SD1_DIV4, R9A07G054L_CLK_SD1, 1, 4),
	...
	DEF_FIXED("M2_DIV2", CLK_M2_DIV2, R9A07G054L_CLK_M2, 1, 2),
	...
	DEF_MUX("HP", R9A07G054L_CLK_HP, SEL_ETH,
...
static struct mssr_mod_clk r9a07g054l_mod_clks[] = {
	...
	DEF_MOD("mipi_dsi_v",	R9A07G054L_CLK_MIPI_DSI_V,
				R9A07G054L_CLK_M3, 0),
	DEF_MOD("mipi_dsi_pin", R9A07G054L_CLK_MIPI_DSI_PIN,
				R9A07G054L_CLK_M1, 0),
...
const struct cpg_mssr_info r9a07g054l_cpg_info = {
	...
	.crit_mod_clks = r9a07g054l_crit_mod_clks,
	.num_crit_mod_clks = ARRAY_SIZE(r9a07g054l_crit_mod_clks),
	/* Module clk */
