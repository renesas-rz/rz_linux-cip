...
static struct mssr_mod_clk r9a07g054l_mod_clks[] = {
	...
	DEF_MOD("scif3",	R9A07G054L_CLK_SCIF3,
				R9A07G054L_CLK_P0,
				MSSR(33, BIT(3), BIT(3)),
				MSTOP(MCPU2_MSTOP, BIT(4))),
	DEF_MOD("scif4",	R9A07G054L_CLK_SCIF4,
				R9A07G054L_CLK_P0,
				MSSR(33, BIT(4), BIT(4)),
				MSTOP(MCPU2_MSTOP, BIT(5))),
	...
	DEF_MOD("mipi_dsi_v",	R9A07G054L_CLK_MIPI_DSI_V,
				R9A07G054L_CLK_M3, 0, 0),
	DEF_MOD("mipi_dsi_pin", R9A07G054L_CLK_MIPI_DSI_PIN,
				R9A07G054L_CLK_M1, 0, 0),
	DEF_MOD("csi2",		R9A07G054L_CLK_CSI2,
				CLK_M2_DIV2,
				MSSR(25, BIT(0), BIT(0)), 0),
	DEF_MOD("poega",	R9A07G054L_CLK_POEGA,
				R9A07G054L_CLK_P0,
				MSSR(17, BIT(0), BIT(0)),
				MSTOP(MCPU1_MSTOP, BIT(5))),
	DEF_MOD("poegb",	R9A07G054L_CLK_POEGB,
				R9A07G054L_CLK_P0,
				MSSR(17, BIT(1), BIT(1)),
				MSTOP(MCPU1_MSTOP, BIT(6))),
	DEF_MOD("poegc",	R9A07G054L_CLK_POEGC,
				R9A07G054L_CLK_P0,
				MSSR(17, BIT(2), BIT(2)),
				MSTOP(MCPU1_MSTOP, BIT(7))),
	DEF_MOD("poegd",	R9A07G054L_CLK_POEGD,
				R9A07G054L_CLK_P0,
				MSSR(17, BIT(3), BIT(3)),
				MSTOP(MCPU1_MSTOP, BIT(8))),
	DEF_MOD("poe3",		R9A07G054L_CLK_POE3,
				R9A07G054L_CLK_P0,
				MSSR(15, BIT(0), BIT(0)),
...
const struct cpg_mssr_info r9a07g054l_cpg_info = {
	...
	.num_hw_mod_clks = R9A07G054L_CLK_POE3 + 1,
};
