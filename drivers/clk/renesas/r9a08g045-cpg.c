...
enum clk_ids {
	...
	LAST_DT_CORE_CLK = R9A08G045_CLK_P4_DIV2,
...
static const struct cpg_core_clk r9a08g045_core_clks[] = {
	...
	DEF_FIXED("P4_DIV2", R9A08G045_CLK_P4_DIV2, R9A08G045_CLK_P4, 1, 2),
...
static const struct rzg2l_mod_clk r9a08g045_mod_clks[] = {
	...
	DEF_MOD("rspi3_clkb",		R9A08G045_RSPI3_CLKB, R9A08G045_CLK_P0, 0x590, 3,
					MSTOP(BUS_MCPU3, BIT(2))),
	DEF_MOD("rspi4_clkb",		R9A08G045_RSPI4_CLKB, R9A08G045_CLK_P0, 0x590, 4,
					MSTOP(BUS_MCPU3, BIT(3))),
	DEF_MOD("canfd_pclk",		R9A08G045_CANFD_PCLK, R9A08G045_CLK_P4_DIV2, 0x594, 0,
