...
static const struct rzg2l_mod_clk r9a08g045_mod_clks[] = {
	...
	DEF_MOD("ostm0_pclk",		R9A08G045_OSTM0_PCLK, R9A08G045_CLK_P0, 0x534, 0),
	DEF_MOD("ostm1_pclk",		R9A08G045_OSTM1_PCLK, R9A08G045_CLK_P0, 0x534, 1),
	DEF_MOD("ostm2_pclk",		R9A08G045_OSTM2_PCLK, R9A08G045_CLK_P0, 0x534, 2),
	DEF_MOD("ostm3_pclk",		R9A08G045_OSTM3_PCLK, R9A08G045_CLK_P0, 0x534, 3),
	DEF_MOD("ostm4_pclk",		R9A08G045_OSTM4_PCLK, R9A08G045_CLK_P0, 0x534, 4),
	DEF_MOD("ostm5_pclk",		R9A08G045_OSTM5_PCLK, R9A08G045_CLK_P0, 0x534, 5),
	DEF_MOD("ostm6_pclk",		R9A08G045_OSTM6_PCLK, R9A08G045_CLK_P0, 0x534, 6),
	DEF_MOD("ostm7_pclk",		R9A08G045_OSTM7_PCLK, R9A08G045_CLK_P0, 0x534, 7),
	DEF_MOD("mtu_x_mck",		R9A08G045_MTU_X_MCK_MTU3, R9A08G045_CLK_P0, 0x538, 0),
	DEF_MOD("poe3_clkm_poe",	R9A08G045_POE3_CLKM_POE, R9A08G045_CLK_P0, 0x53C, 0),
	DEF_MOD("gpt_pclk",		R9A08G045_GPT_PCLK, R9A08G045_CLK_P0, 0x540, 0),
	DEF_MOD("poeg_a_clkp",		R9A08G045_POEG_A_CLKP, R9A08G045_CLK_P0, 0x544, 0),
	DEF_MOD("poeg_b_clkp",		R9A08G045_POEG_B_CLKP, R9A08G045_CLK_P0, 0x544, 1),
	DEF_MOD("poeg_c_clkp",		R9A08G045_POEG_C_CLKP, R9A08G045_CLK_P0, 0x544, 2),
	DEF_MOD("poeg_d_clkp",		R9A08G045_POEG_D_CLKP, R9A08G045_CLK_P0, 0x544, 3),
	...
	DEF_MOD("src_clkp",		R9A08G045_SRC_CLKP, R9A08G045_CLK_P0, 0x574, 0),
	DEF_MOD("usb_u2h0_hclk",	R9A08G045_USB_U2H0_HCLK, R9A08G045_CLK_P1, 0x578, 0),
	DEF_MOD("usb_u2h1_hclk",	R9A08G045_USB_U2H1_HCLK, R9A08G045_CLK_P1, 0x578, 1),
	DEF_MOD("usb_u2p_exr_cpuclk",	R9A08G045_USB_U2P_EXR_CPUCLK, R9A08G045_CLK_P1, 0x578, 2),
	...
	DEF_MOD("rspi0_clkb",		R9A08G045_RSPI0_CLKB, R9A08G045_CLK_P0, 0x590, 0),
	DEF_MOD("rspi1_clkb",		R9A08G045_RSPI1_CLKB, R9A08G045_CLK_P0, 0x590, 1),
	DEF_MOD("rspi2_clkb",		R9A08G045_RSPI2_CLKB, R9A08G045_CLK_P0, 0x590, 2),
	DEF_MOD("rspi3_clkb",		R9A08G045_RSPI3_CLKB, R9A08G045_CLK_P0, 0x590, 3),
	DEF_MOD("rspi4_clkb",		R9A08G045_RSPI4_CLKB, R9A08G045_CLK_P0, 0x590, 4),
...
static const struct rzg2l_cpg_pm_domain_init_data r9a08g045_pm_domains[] = {
	...
	DEF_PD("src",		R9A08G045_PD_SRC,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(3)), 0),
	DEF_PD("gpt",		R9A08G045_PD_GPT,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(4)), 0),
	DEF_PD("poega",		R9A08G045_PD_POEGA,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(5)), 0),
	DEF_PD("poegb",		R9A08G045_PD_POEGB,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(6)), 0),
	DEF_PD("poegc",		R9A08G045_PD_POEGC,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(7)), 0),
	DEF_PD("poegd",		R9A08G045_PD_POEGD,
				DEF_REG_CONF(CPG_BUS_MCPU1_MSTOP, BIT(8)), 0),
	...
	DEF_PD("rspi2",		R9A08G045_PD_RSPI2,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(0)), 0),
	...
	DEF_PD("sci0",		R9A08G045_PD_SCI0,
				DEF_REG_CONF(CPG_BUS_MCPU2_MSTOP, BIT(7)), 0),
	...
	DEF_PD("rspi3",		R9A08G045_PD_RSPI3,
				DEF_REG_CONF(CPG_BUS_MCPU3_MSTOP, BIT(2)), 0),
	DEF_PD("rspi4",		R9A08G045_PD_RSPI4,
				DEF_REG_CONF(CPG_BUS_MCPU3_MSTOP, BIT(3)), 0),
	DEF_PD("scif5",		R9A08G045_PD_SCIF5,
				DEF_REG_CONF(CPG_BUS_MCPU3_MSTOP, BIT(4)), 0),
	DEF_PD("spdif",		R9A08G045_PD_SPDIF,
				DEF_REG_CONF(CPG_BUS_MCPU3_MSTOP, BIT(6)), 0),
	DEF_PD("vbat",		R9A08G045_PD_VBAT,
				DEF_REG_CONF(CPG_BUS_MCPU3_MSTOP, BIT(8)), 0),
