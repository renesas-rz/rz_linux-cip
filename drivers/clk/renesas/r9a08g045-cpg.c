...
static const struct cpg_core_clk r9a08g045_core_clks[] __initconst = {
	...
	DEF_MUX(".sel_octa", CLK_SEL_OCTA, SEL_OCTA_G3S, sel_spi_octa,
		ARRAY_SIZE(sel_spi_octa), 0, CLK_MUX_HIWORD_MASK),
	DEF_SD_MUX(".sel_sdhi0", CLK_SEL_SDHI0, SEL_SDHI0_G3S,
		sel_sdhi, ARRAY_SIZE(sel_sdhi)),
	DEF_SD_MUX(".sel_sdhi1", CLK_SEL_SDHI1, SEL_SDHI1_G3S,
		sel_sdhi, ARRAY_SIZE(sel_sdhi)),
	DEF_SD_MUX(".sel_sdhi2", CLK_SEL_SDHI2, SEL_SDHI2_G3S,
		sel_sdhi, ARRAY_SIZE(sel_sdhi)),
	...
	DEF_FIXED("P4", R9A08G045_CLK_P4, CLK_PLL2_DIV2, 1, 4),
	DEF_FIXED("P4_DIV2", CLK_P4_DIV2, R9A08G045_CLK_P4, 1, 2),
	DEF_FIXED("P5", R9A08G045_CLK_P5, CLK_PLL2_DIV2, 1, 5),
	...
	DEF_DIV("SD0", R9A08G045_CLK_SD0, CLK_SEL_SDHI0,
		DIV_SDHI0_G3S, dtable_1_2, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("SD1", R9A08G045_CLK_SD1, CLK_SEL_SDHI1,
		DIV_SDHI1_G3S, dtable_1_2, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("SD2", R9A08G045_CLK_SD2, CLK_SEL_SDHI2,
		DIV_SDHI2_G3S, dtable_1_2, CLK_DIVIDER_HIWORD_MASK),
...
static struct rzg2l_mod_clk r9a08g045_mod_clks[] = {
	...
	DEF_MOD("wdt1_pclk",	R9A08G045_WDT1_PCLK, R9A08G045_CLK_P0,
				0x548, 2, 0),
	DEF_MOD("wdt1_clk",	R9A08G045_WDT1_CLK, R9A08G045_OSCCLK,
				0x548, 3, MSTOP(REG0_MSTOP, BIT(1))),
	DEF_MOD("wdt2_pclk",	R9A08G045_WDT2_PCLK, R9A08G045_CLK_P0,
				0x548, 4, 0),
	DEF_MOD("wdt2_clk",	R9A08G045_WDT2_CLK, R9A08G045_OSCCLK,
				0x548, 5, MSTOP(REG0_MSTOP, BIT(2))),
