...
static const struct rzg2l_mod_clk r9a08g045_mod_clks[] = {
	...
	DEF_MOD("spi_hclk",		R9A08G045_SPI_HCLK, R9A08G045_CLK_P3, 0x550, 0),
	DEF_MOD("spi_aclk",		R9A08G045_SPI_ACLK, R9A08G045_CLK_P3, 0x550, 1),
	DEF_MOD("spi_clk",		R9A08G045_SPI_CLK, R9A08G045_CLK_SPI1, 0x550, 2),
	DEF_MOD("spi_clkx2",		R9A08G045_SPI_CLKX2, R9A08G045_CLK_SPI0, 0x550, 3),
	...
	DEF_MOD("sci0_clk_pck",		R9A08G045_SCI0_CLKP, R9A08G045_CLK_P0, 0x588, 0),
	DEF_MOD("sci1_clk_pck",		R9A08G045_SCI1_CLKP, R9A08G045_CLK_P0, 0x588, 1),
