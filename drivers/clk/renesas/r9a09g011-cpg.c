...
static const struct rzg2l_mod_clk r9a09g011_mod_clks[] __initconst = {
	...
	DEF_MOD("iic_pclk0",	R9A09G011_IIC_PCLK0,	 CLK_SEL_E,    0x420, 12, 0),
        DEF_MOD("cperi_grpa",   R9A09G011_CPERI_GRPA_PCLK, CLK_SEL_E,  0x420, 0, 0),
        DEF_MOD("tim_clk_0",    R9A09G011_TIM0_CLK,      CLK_MAIN_2,   0x420, 4, 0),
        DEF_MOD("tim_clk_1",    R9A09G011_TIM1_CLK,      CLK_MAIN_2,   0x420, 5, 0),
        DEF_MOD("tim_clk_2",	R9A09G011_TIM2_CLK,	 CLK_MAIN_2,   0x420, 6, 0),
        DEF_MOD("tim_clk_3",	R9A09G011_TIM3_CLK,      CLK_MAIN_2,   0x420, 7, 0),
        DEF_MOD("tim_clk_4",	R9A09G011_TIM4_CLK,      CLK_MAIN_2,   0x420, 8, 0),
        DEF_MOD("tim_clk_5",	R9A09G011_TIM5_CLK,	 CLK_MAIN_2,   0x420, 9, 0),
        DEF_MOD("tim_clk_6",	R9A09G011_TIM6_CLK,	 CLK_MAIN_2,   0x420, 10, 0),
        DEF_MOD("tim_clk_7",	R9A09G011_TIM7_CLK,	 CLK_MAIN_2,   0x420, 11, 0),
	...
	DEF_MOD("cperi_grpd",   R9A09G011_CPERI_GRPD_PCLK, CLK_SEL_E,  0x42c, 0, 0),
	DEF_MOD("tim_clk_24",   R9A09G011_TIM24_CLK,     CLK_MAIN_2,   0x42c, 4, 0),
	DEF_MOD("tim_clk_25",   R9A09G011_TIM25_CLK,     CLK_MAIN_2,   0x42c, 5, 0),
	DEF_MOD("tim_clk_26",   R9A09G011_TIM26_CLK,     CLK_MAIN_2,   0x42c, 6, 0),
	DEF_MOD("tim_clk_27",   R9A09G011_TIM27_CLK,     CLK_MAIN_2,   0x42c, 7, 0),
	DEF_MOD("tim_clk_28",   R9A09G011_TIM28_CLK,     CLK_MAIN_2,   0x42c, 8, 0),
	DEF_MOD("tim_clk_29",   R9A09G011_TIM29_CLK,     CLK_MAIN_2,   0x42c, 9, 0),
	DEF_MOD("tim_clk_30",   R9A09G011_TIM30_CLK,     CLK_MAIN_2,   0x42c, 10, 0),
	...
	DEF_MOD("csi5_clk",     R9A09G011_CSI5_CLK,      CLK_SEL_CSI5, 0x438, 13, 0),
        ...
        DEF_MOD("pwm2_clk",     R9A09G011_PWM2_CLK,      CLK_MAIN,     0x430, 6, 0),
        DEF_MOD("pwm3_clk",     R9A09G011_PWM3_CLK,      CLK_MAIN,     0x430, 7, 0),
        DEF_MOD("pwm4_clk",     R9A09G011_PWM4_CLK,      CLK_MAIN,     0x430, 8, 0),
        DEF_MOD("pwm5_clk",     R9A09G011_PWM5_CLK,      CLK_MAIN,     0x430, 9, 0),
        DEF_MOD("pwm6_clk",     R9A09G011_PWM6_CLK,      CLK_MAIN,     0x430, 10, 0),
        DEF_MOD("pwm7_clk",     R9A09G011_PWM7_CLK,      CLK_MAIN,     0x430, 11, 0),
