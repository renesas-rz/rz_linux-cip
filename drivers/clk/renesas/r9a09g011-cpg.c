...
static const struct rzg2l_mod_clk r9a09g011_mod_clks[] __initconst = {
	...
	DEF_MOD("dmaa_aclk",	R9A09G011_DMAA_ACLK,	CLK_SEL_D,	0x400, 11),
	...
	DEF_MOD("cperi_grpa",	R9A09G011_CPERI_GRPA_PCLK, CLK_SEL_E,	0x420, 0),
	DEF_MOD("tim_clk_0",	R9A09G011_TIM0_CLK,	CLK_MAIN_2,	0x420, 4),
	DEF_MOD("tim_clk_1",	R9A09G011_TIM1_CLK,	CLK_MAIN_2,	0x420, 5),
	DEF_MOD("tim_clk_2",	R9A09G011_TIM2_CLK,	CLK_MAIN_2,	0x420, 6),
	DEF_MOD("tim_clk_3",	R9A09G011_TIM3_CLK,	CLK_MAIN_2,	0x420, 7),
	DEF_MOD("tim_clk_4",	R9A09G011_TIM4_CLK,	CLK_MAIN_2,	0x420, 8),
	DEF_MOD("tim_clk_5",	R9A09G011_TIM5_CLK,	CLK_MAIN_2,	0x420, 9),
	DEF_MOD("tim_clk_6",	R9A09G011_TIM6_CLK,	CLK_MAIN_2,	0x420, 10),
	DEF_MOD("tim_clk_7",	R9A09G011_TIM7_CLK,	CLK_MAIN_2,	0x420, 11),
	...
	DEF_MOD("wdt1_pclk",	R9A09G011_WDT1_PCLK,	CLK_SEL_E,	0x428, 14),
	DEF_MOD("wdt1_clk",	R9A09G011_WDT1_CLK,	CLK_MAIN,	0x428, 15),
	DEF_MOD("cperi_grpd",	R9A09G011_CPERI_GRPD_PCLK, CLK_SEL_E,  0x42c, 0),
	DEF_MOD("tim_clk_24",	R9A09G011_TIM24_CLK,     CLK_MAIN_2,   0x42c, 4),
	DEF_MOD("tim_clk_25",	R9A09G011_TIM25_CLK,     CLK_MAIN_2,   0x42c, 5),
	DEF_MOD("tim_clk_26",	R9A09G011_TIM26_CLK,     CLK_MAIN_2,   0x42c, 6),
	DEF_MOD("tim_clk_27",	R9A09G011_TIM27_CLK,     CLK_MAIN_2,   0x42c, 7),
	DEF_MOD("tim_clk_28",	R9A09G011_TIM28_CLK,     CLK_MAIN_2,   0x42c, 8),
	DEF_MOD("tim_clk_29",	R9A09G011_TIM29_CLK,     CLK_MAIN_2,   0x42c, 9),
	DEF_MOD("tim_clk_30",	R9A09G011_TIM30_CLK,     CLK_MAIN_2,   0x42c, 10),
	DEF_MOD("tim_clk_31",	R9A09G011_TIM31_CLK,     CLK_MAIN_2,   0x42c, 11),
	DEF_MOD("cperi_grpe",	R9A09G011_CPERI_GRPE_PCLK, CLK_SEL_E,	0x430, 0),
	DEF_MOD("pwm0_clk",	R9A09G011_PWM0_CLK,	CLK_MAIN,	0x430, 4),
	DEF_MOD("pwm1_clk",	R9A09G011_PWM1_CLK,	CLK_MAIN,	0x430, 5),
	DEF_MOD("pwm2_clk",	R9A09G011_PWM2_CLK,	CLK_MAIN,	0x430, 6),
	DEF_MOD("pwm3_clk",	R9A09G011_PWM3_CLK,	CLK_MAIN,	0x430, 7),
	DEF_MOD("pwm4_clk",	R9A09G011_PWM4_CLK,	CLK_MAIN,	0x430, 8),
	DEF_MOD("pwm5_clk",	R9A09G011_PWM5_CLK,	CLK_MAIN,	0x430, 9),
	DEF_MOD("pwm6_clk",	R9A09G011_PWM6_CLK,	CLK_MAIN,	0x430, 10),
	DEF_MOD("pwm7_clk",	R9A09G011_PWM7_CLK,	CLK_MAIN,	0x430, 11),
	...
	DEF_MOD("pwm15_clk",	R9A09G011_PWM15_CLK,	CLK_MAIN,	0x434, 11),
	...
	DEF_MOD("urt1_clk",	R9A09G011_URT1_CLK,	CLK_SEL_W0,	0x438, 6),
	DEF_MOD("csi0_clk",	R9A09G011_CSI0_CLK,	CLK_SEL_CSI0,	0x438, 8),
	DEF_MOD("csi1_clk",	R9A09G011_CSI1_CLK,	CLK_SEL_CSI1,	0x438, 9),
	DEF_MOD("csi2_clk",	R9A09G011_CSI2_CLK,	CLK_SEL_CSI2,	0x438, 10),
	DEF_MOD("csi3_clk",	R9A09G011_CSI3_CLK,	CLK_SEL_CSI3,	0x438, 11),
	DEF_MOD("csi4_clk",	R9A09G011_CSI4_CLK,	CLK_SEL_CSI4,	0x438, 12),
	DEF_MOD("csi5_clk",	R9A09G011_CSI5_CLK,	CLK_SEL_CSI5,	0x438, 13),
...
static const struct rzg2l_reset r9a09g011_resets[] = {
	...
	DEF_RST(R9A09G011_TIM_GPA_PRESETN,	0x614, 0),
	...
	DEF_RST_MON(R9A09G011_PWM_GPE_PRESETN,	0x614, 4, 22),
	...
	DEF_RST_MON(R9A09G011_WDT1_PRESETN,	0x614, 13, 20),
...
static const unsigned int r9a09g011_crit_mod_clks[] __initconst = {
	...
	MOD_CLK_BASE + R9A09G011_CPERI_GRPE_PCLK,
	...
	MOD_CLK_BASE + R9A09G011_URT0_CLK,
	MOD_CLK_BASE + R9A09G011_URT1_CLK,
	MOD_CLK_BASE + R9A09G011_IIC_PCLK0,
	MOD_CLK_BASE + R9A09G011_IIC_PCLK1,
	MOD_CLK_BASE + R9A09G011_WDT1_PCLK,
	MOD_CLK_BASE + R9A09G011_WDT1_CLK,
	MOD_CLK_BASE + R9A09G011_PWM0_CLK,
	MOD_CLK_BASE + R9A09G011_PWM1_CLK,
	MOD_CLK_BASE + R9A09G011_PWM2_CLK,
	MOD_CLK_BASE + R9A09G011_PWM3_CLK,
	MOD_CLK_BASE + R9A09G011_PWM4_CLK,
	MOD_CLK_BASE + R9A09G011_PWM5_CLK,
	MOD_CLK_BASE + R9A09G011_PWM6_CLK,
	MOD_CLK_BASE + R9A09G011_PWM7_CLK,
	MOD_CLK_BASE + R9A09G011_DMAA_ACLK,
