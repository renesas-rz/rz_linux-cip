...
static const struct cpg_core_clk r9a09g047_core_clks[] __initconst = {
	...
	DEF_PLL(".plldsi0", CLK_PLLDSI0, CLK_QEXTAL, PLL_CONF(0xC4)),
	DEF_PLL(".plldsi1", CLK_PLLDSI1, CLK_QEXTAL, PLL_CONF(0x164)),
	...
	DEF_MUX(".smux2_gbe0_txclk", CLK_SMUX2_GBE0_TXCLK, SSEL_SELCTL(0, 2), smux2_gbe0_txclk),
	DEF_MUX(".smux2_gbe0_rxclk", CLK_SMUX2_GBE0_RXCLK, SSEL_SELCTL(0, 3), smux2_gbe0_rxclk),
	DEF_MUX(".smux2_gbe1_txclk", CLK_SMUX2_GBE1_TXCLK, SSEL_SELCTL(1, 0), smux2_gbe1_txclk),
	DEF_MUX(".smux2_gbe1_rxclk", CLK_SMUX2_GBE1_RXCLK, SSEL_SELCTL(1, 1), smux2_gbe1_rxclk),
	DEF_SDIV(".plleth_lpclk", CLK_PLLETH_LPCLK, CLK_PLLETH_DIV4, CSDIV0_DIVCTL2, dtable_16_128),
	DEF_SDIV(".plldsi0_csdiv", CLK_PLLDSI0_CSDIV, CLK_PLLDSI0, CSDIV1_DIVCTL2, dtable_2_16),
	DEF_SDIV(".plldsi1_csdiv", CLK_PLLDSI1_CSDIV, CLK_PLLDSI1, CSDIV1_DIVCTL3, dtable_2_16),
