...
static const struct cpg_core_clk r9a09g056_core_clks[] = {
	...
	DEF_FIXED(".pllddr0", CLK_PLLDDR0, CLK_QEXTAL, 100, 3),
	...
	DEF_DDIV(".plldty_drp", CLK_PLLDTY_DRP, CLK_PLLDTY, CDDIV2_DIVCTL2, dtable_2_64),
...
static const struct rzv2h_mod_clk r9a09g056_mod_clks[] = {
	...
	DEF_MOD("rspi_2_tclk",			CLK_PLLCLN_DIV8, 5, 12, 2, 28,
						BUS_MSTOP(11, BIT(2))),
	DEF_MOD("rsci_0_pclk",			CLK_PLLCLN_DIV16, 5, 13, 2, 29,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_0_tclk",			CLK_PLLCLN_DIV16, 5, 14, 2, 30,
						BUS_MSTOP(11, BIT(3))),
	...
	DEF_MOD("rsci_0_ps_ps1_n",		CLK_PLLCLN_DIV64, 6, 1, 3, 1,
						BUS_MSTOP(11, BIT(3))),
	DEF_MOD("rsci_1_pclk",			CLK_PLLCLN_DIV16, 6, 2, 3, 2,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_1_tclk",			CLK_PLLCLN_DIV16, 6, 3, 3, 3,
						BUS_MSTOP(11, BIT(4))),
	...
	DEF_MOD("rsci_1_ps_ps1_n",		CLK_PLLCLN_DIV64, 6, 6, 3, 6,
						BUS_MSTOP(11, BIT(4))),
	DEF_MOD("rsci_2_pclk",			CLK_PLLCLN_DIV16, 6, 7, 3, 7,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_2_tclk",			CLK_PLLCLN_DIV16, 6, 8, 3, 8,
						BUS_MSTOP(11, BIT(5))),
	...
	DEF_MOD("rsci_2_ps_ps1_n",		CLK_PLLCLN_DIV64, 6, 11, 3, 11,
						BUS_MSTOP(11, BIT(5))),
	DEF_MOD("rsci_3_pclk",			CLK_PLLCLN_DIV16, 6, 12, 3, 12,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_3_tclk",			CLK_PLLCLN_DIV16, 6, 13, 3, 13,
						BUS_MSTOP(11, BIT(6))),
	...
	DEF_MOD("rsci_3_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 0, 3, 16,
						BUS_MSTOP(11, BIT(6))),
	DEF_MOD("rsci_4_pclk",			CLK_PLLCLN_DIV16, 7, 1, 3, 17,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_4_tclk",			CLK_PLLCLN_DIV16, 7, 2, 3, 18,
						BUS_MSTOP(11, BIT(7))),
	...
	DEF_MOD("rsci_4_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 5, 3, 21,
						BUS_MSTOP(11, BIT(7))),
	DEF_MOD("rsci_5_pclk",			CLK_PLLCLN_DIV16, 7, 6, 3, 22,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_5_tclk",			CLK_PLLCLN_DIV16, 7, 7, 3, 23,
						BUS_MSTOP(11, BIT(8))),
	...
	DEF_MOD("rsci_5_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 10, 3, 26,
						BUS_MSTOP(11, BIT(8))),
	DEF_MOD("rsci_6_pclk",			CLK_PLLCLN_DIV16, 7, 11, 3, 27,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_6_tclk",			CLK_PLLCLN_DIV16, 7, 12, 3, 28,
						BUS_MSTOP(11, BIT(9))),
	...
	DEF_MOD("rsci_6_ps_ps1_n",		CLK_PLLCLN_DIV64, 7, 15, 3, 31,
						BUS_MSTOP(11, BIT(9))),
	DEF_MOD("rsci_7_pclk",			CLK_PLLCLN_DIV16, 8, 0, 4, 0,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_7_tclk",			CLK_PLLCLN_DIV16, 8, 1, 4, 1,
						BUS_MSTOP(11, BIT(10))),
	...
	DEF_MOD("rsci_7_ps_ps1_n",		CLK_PLLCLN_DIV64, 8, 4, 4, 4,
						BUS_MSTOP(11, BIT(10))),
	DEF_MOD("rsci_8_pclk",			CLK_PLLCLN_DIV16, 8, 5, 4, 5,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_8_tclk",			CLK_PLLCLN_DIV16, 8, 6, 4, 6,
						BUS_MSTOP(11, BIT(11))),
	...
	DEF_MOD("rsci_8_ps_ps1_n",		CLK_PLLCLN_DIV64, 8, 9, 4, 9,
						BUS_MSTOP(11, BIT(11))),
	DEF_MOD("rsci_9_pclk",			CLK_PLLCLN_DIV16, 8, 10, 4, 10,
						BUS_MSTOP(11, BIT(12))),
	DEF_MOD("rsci_9_tclk",			CLK_PLLCLN_DIV16, 8, 11, 4, 11,
						BUS_MSTOP(11, BIT(12))),
	...
	DEF_MOD("vcd_0_aclk",			CLK_PLLDTY_DIV4, 15, 3, 7, 19,
						BUS_MSTOP(9, BIT(11) | BIT(12) | BIT(13))),
	...
	DEF_MOD("tsu_1_pclk",			CLK_QEXTAL, 16, 10, 8, 10,
						BUS_MSTOP(2, BIT(15))),
	DEF_MOD("drpai_0_dclkin",		CLK_PLLDRP, 17, 3, 8, 19,
						BUS_MSTOP(8, BIT(9))),
	DEF_MOD("drpai_0_aclk",			CLK_PLLDTY_DRP_DIV2, 17, 4, 8, 20,
						BUS_MSTOP(8, BIT(9))),
	DEF_MOD("drpai_0_initclk",		CLK_QEXTAL, 17, 5, 8, 21,
						BUS_MSTOP(8, BIT(9))),
	DEF_MOD("drpai_0_mclk",			CLK_PLLETH, 17, 6, 8, 22,
						BUS_MSTOP(8, BIT(9))),
	...
	DEF_MOD("dvc_1_clk",			CLK_PLLCLN_DIV8, 23, 1, -1, -1,
						BUS_MSTOP(2, BIT(0) | BIT(1))),
	DEF_MOD("ctu_0_mix0_clk",		CLK_PLLCLN_DIV8, 23, 2, -1, -1,
						BUS_MSTOP(2, BIT(0) | BIT(1))),
	DEF_MOD("ctu_1_mix1_clk",		CLK_PLLCLN_DIV8, 23, 3, -1, -1,
						BUS_MSTOP(2, BIT(0) | BIT(1))),
...
static const struct rzv2h_reset r9a09g056_resets[] = {
	...
	DEF_RST(5, 13, 2, 14),		/* POEGA_0_RST */
	DEF_RST(5, 14, 2, 15),		/* POEGB_0_RST */
	DEF_RST(5, 15, 2, 16),		/* POEGC_0_RST */
	DEF_RST(6, 0, 2, 17),		/* POEGD_0_RST */
	DEF_RST(6, 1, 2, 18),		/* POEGA_1_RST */
	DEF_RST(6, 2, 2, 19),		/* POEGB_1_RST */
	DEF_RST(6, 3, 2, 20),		/* POEGC_1_RST */
	DEF_RST(6, 4, 2, 21),		/* POEGD_1_RST */
