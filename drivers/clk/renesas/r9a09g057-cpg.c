...
static const struct cpg_core_clk r9a09g057_core_clks[] __initconst = {
	...
	DEF_SDIV(".pllcm33_adc_pclk", CLK_PLLCM33_ADC_PCLK, CLK_PLLCM33_DIV2, CSDIV1_DIVCTL0, dtable_8_10),
	DEF_FIXED(".pllcm33_adc_pclk_div2", CLK_PLLCM33_ADC_PCLK_DIV2, CLK_PLLCM33_ADC_PCLK, 1, 2),
	DEF_SDIV(".pllcm33_adc_adclk", CLK_PLLCM33_ADC_ADCLK, CLK_PLLCM33_ADC_PCLK, CSDIV1_DIVCTL1, dtable_2_16),
	DEF_DDIV(".pllcm33_div4_ddiv2", CLK_PLLCM33_DIV4_DDIV2, CLK_PLLCM33_DIV4, CDDIV0_DIVCTL1, dtable_2_64),
	DEF_MUX(".smux2_xspi_clk0", CLK_SMUX2_XSPI_CLK0, SSEL1_SELCTL2, smux2_xspi_clk0),
	DEF_MUX(".smux2_xspi_clk1", CLK_SMUX2_XSPI_CLK1, SSEL1_SELCTL3, smux2_xspi_clk1),
	DEF_DDIV(".pllcm33_xspi", CLK_PLLCM33_XSPI, CLK_SMUX2_XSPI_CLK1, CSDIV0_DIVCTL3, dtable_2_16),
	...
	DEF_SDIV(".plleth_gbe0", CLK_PLLETH_GBE0, CLK_PLLETH_DIV4, CSDIV0_DIVCTL0, dtable_2_100),
	DEF_SDIV(".plleth_gbe1", CLK_PLLETH_GBE1, CLK_PLLETH_DIV4, CSDIV0_DIVCTL1, dtable_2_100),
	DEF_MUX(".smux2_gbe0_txclk", CLK_SMUX2_GBE0_TXCLK, SSEL0_SELCTL2, smux2_gbe0_txclk),
	DEF_MUX(".smux2_gbe0_rxclk", CLK_SMUX2_GBE0_RXCLK, SSEL0_SELCTL3, smux2_gbe0_rxclk),
	DEF_MUX(".smux2_gbe1_txclk", CLK_SMUX2_GBE1_TXCLK, SSEL1_SELCTL0, smux2_gbe1_txclk),
	DEF_MUX(".smux2_gbe1_rxclk", CLK_SMUX2_GBE1_RXCLK, SSEL1_SELCTL1, smux2_gbe1_rxclk),
	DEF_SDIV(".plleth_lpclk", CLK_PLLETH_LPCLK, CLK_PLLETH_DIV4, CSDIV0_DIVCTL2, dtable_16_128),
	DEF_SDIV(".plldsi_sdiv2", CLK_PLLDSI_SDIV2, CLK_PLLDSI, CSDIV1_DIVCTL2, dtable_2_32),
