...
static const struct rzt2_mod_clk r9a09g077_mod_clks[] __initconst = {
	...
	DEF_MOD("gpt10",	R9A09G077_GPT10_CLK, R9A09G077_PCLKM,
				0x318, 3, 1),
	DEF_MOD("adc0",		R9A09G077_ADC0_CLK, R9A09G077_PCLKL,
				0x308, 6, 0),
	DEF_MOD("adc1",		R9A09G077_ADC1_CLK, R9A09G077_PCLKL,
				0x308, 7, 0),
	DEF_MOD("adc2",		R9A09G077_ADC2_CLK, R9A09G077_PCLKL,
				0x308, 25, 0),
...
const struct rzt2_cpg_info r9a09g077_cpg_info = {
	...
	.num_hw_mod_clks = R9A09G077_CANFD_CLK + 1,
