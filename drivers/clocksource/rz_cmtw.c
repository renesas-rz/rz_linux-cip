...
static const struct rz_cmtw_info rzt2n_cmtw_info = {
	.num_channels = 1,
	.channel_offset = 0x0,
	.is_cmtw = true,
	.width = 32,
...
static const struct rz_cmtw_info rzt2n_cmt_info = {
	.num_channels = 2,
	.channel_offset = 0x6,
	.is_cmtw = false,
	.width = 16,
...
static const struct of_device_id rz_cmtw_of_table[] __maybe_unused = {
	...
	{ .compatible = "renesas,rzt2n-cmtw", .data = &rzt2n_cmtw_info },
	{ .compatible = "renesas,rzt2n-cmt", .data = &rzt2n_cmt_info },
	{ }
};
