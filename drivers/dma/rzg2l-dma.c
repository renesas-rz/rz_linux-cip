...
union dmars_reg {
	...
	struct {
		u32 rid:   2;	/* LSB */
#if defined(CONFIG_ARCH_R9A07G044L2) || defined(CONFIG_ARCH_R9A07G044C2) || defined(CONFIG_ARCH_R9A07G043U) || defined(CONFIG_ARCH_R9A07G043F)
		u32 mid:   8;
		u32 _mbz0:22;
#else
		u32 mid:   7;
			     ...
			     const struct rzg2l_dma_conf *psoc)
{
	...
	int n_slaves;
	int ret;
	struct rzg2l_dma_slave_config *rzg2l_dma_slaves;
	...
	rzg2l_dma_slaves = devm_kzalloc(dev, \
						n_slaves * sizeof(struct rzg2l_dma_slave_config), \
						GFP_KERNEL);
	if(!rzg2l_dma_slaves)
		return -ENOMEM;
...
#endif
#ifdef CONFIG_R9A07G043U_DMA
	{
		.compatible = "renesas,r9a07g043u-dma",
		.data = &r9a07g044l_dma_config,
	},
#endif
#ifdef CONFIG_R9A07G043F_DMA
	{
		.compatible = "renesas,r9a07g043f-dma",
		.data = &r9a07g044l_dma_config,
	},
#endif
	{},
