...
int rpcif_sw_init(struct rpcif *rpcif, struct device *dev)
{
	...
	rpcif->size = rpc->size;
	rpcif->xspi = rpc->info->type == XSPI_RZ_G3S;
	return 0;
}
...
static const struct rpcif_info xspi_info_r9a08g045 = {
...
static const struct of_device_id rpcif_of_match[] = {
	...
	{ .compatible = "renesas,g3s-xspi-if", .data = &xspi_info_r9a08g045 },
	{},
};
