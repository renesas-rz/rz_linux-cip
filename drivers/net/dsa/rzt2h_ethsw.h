...
#define ETHSW_PORT_ENA_TX_RX(port)	((BIT(port) << ETHSW_PORT_ENA_RX_SHIFT) | BIT(port))
...
/* Stats */
#define ETHSW_aFramesTransmittedOK		0x868
#define ETHSW_aFramesReceivedOK			0x86C
#define ETHSW_aFrameCheckSequenceErrors		0x870
#define ETHSW_aAlignmentErrors			0x874
#define ETHSW_aOctetsTransmittedOK		0x878
#define ETHSW_aOctetsReceivedOK			0x87C
#define ETHSW_aTxPAUSEMACCtrlFrames		0x880
#define ETHSW_aRxPAUSEMACCtrlFrames		0x884
/* If */
#define ETHSW_ifInErrors			0x888
#define ETHSW_ifOutErrors			0x88C
#define ETHSW_ifInUcastPkts			0x890
#define ETHSW_ifInMulticastPkts			0x894
#define ETHSW_ifInBroadcastPkts			0x898
#define ETHSW_ifOutDiscards			0x89C
#define ETHSW_ifOutUcastPkts			0x8A0
#define ETHSW_ifOutMulticastPkts		0x8A4
#define ETHSW_ifOutBroadcastPkts		0x8A8
/* Ether */
#define ETHSW_etherStatsDropEvents		0x8AC
#define ETHSW_etherStatsOctets			0x8B0
#define ETHSW_etherStatsPkts			0x8B4
#define ETHSW_etherStatsUndersizePkts		0x8B8
#define ETHSW_etherStatsOversizePkts		0x8BC
#define ETHSW_etherStatsPkts64Octets		0x8C0
#define ETHSW_etherStatsPkts65to127Octets	0x8C4
#define ETHSW_etherStatsPkts128to255Octets	0x8C8
#define ETHSW_etherStatsPkts256to511Octets	0x8CC
#define ETHSW_etherStatsPkts512to1023Octets	0x8D0
#define ETHSW_etherStatsPkts1024to1518Octets	0x8D4
#define ETHSW_etherStatsPkts1519toXOctets	0x8D8
#define ETHSW_etherStatsJabbers			0x8DC
#define ETHSW_etherStatsFragments		0x8E0

#define ETHSW_VLANReceived			0x8E8
#define ETHSW_VLANTransmitted			0x8EC

#define ETHSW_aDeferred				0x910
#define ETHSW_aMultipleCollisions		0x914
#define ETHSW_aSingleCollisions			0x918
#define ETHSW_aLateCollisions			0x91C
#define ETHSW_aExcessiveCollisions		0x920
#define ETHSW_aCarrierSenseErrors		0x924
