...
static const struct of_device_id ravb_match_table[] = {
	...
	{ .compatible = "renesas,etheravb-r8a7742", .data = &ravb_gen2_hw_info },
	{ .compatible = "renesas,etheravb-r8a7743", .data = &ravb_gen2_hw_info },
	{ .compatible = "renesas,etheravb-r8a7744", .data = &ravb_gen2_hw_info },
	{ .compatible = "renesas,etheravb-r8a7745", .data = &ravb_gen2_hw_info },
	{ .compatible = "renesas,etheravb-r8a77470", .data = &ravb_gen2_hw_info },
...
static int __maybe_unused ravb_runtime_suspend(struct device *dev)
{
	struct net_device *ndev = dev_get_drvdata(dev);
	struct ravb_private *priv = netdev_priv(ndev);
...
static int __maybe_unused ravb_runtime_resume(struct device *dev)
{
	struct net_device *ndev = dev_get_drvdata(dev);
	struct ravb_private *priv = netdev_priv(ndev);
...
static const struct dev_pm_ops ravb_dev_pm_ops = {
	...
	SET_RUNTIME_PM_OPS(ravb_runtime_suspend, ravb_runtime_resume, NULL)
};
