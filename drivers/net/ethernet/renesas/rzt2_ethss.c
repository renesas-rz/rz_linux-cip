 ...
 *	  then index 0 - 4 are CONV0 - CONV4.
 */
...
static struct modctrl_match modctrl_match_table[] = {
	{0x0, {ETHSS_GMAC0_PORT, ETHSS_SWITCH_PORT0, ETHSS_SWITCH_PORT1,
	       ETHSS_SWITCH_PORT2, ETHSS_GMAC1_PORT, ETHSS_GMAC2_PORT}},

	{0x1, {ETHSS_MODCTRL_CONF_NONE, ETHSS_ETHERCAT_PORT0, ETHSS_ETHERCAT_PORT1,
	       ETHSS_ETHERCAT_PORT2, ETHSS_GMAC1_PORT, ETHSS_GMAC2_PORT}},

	{0x2, {ETHSS_GMAC0_PORT, ETHSS_HPSW_PORTA, ETHSS_HPSW_PORTB,
	       ETHSS_MODCTRL_CONF_NONE, ETHSS_GMAC1_PORT, ETHSS_GMAC2_PORT}},

	{0x3, {ETHSS_MODCTRL_CONF_NONE, ETHSS_ESWM_PORT0, ETHSS_ESWM_PORT1,
	       ETHSS_GMAC0_PORT, ETHSS_GMAC1_PORT, ETHSS_GMAC2_PORT}},

	{0x4, {ETHSS_GMAC0_PORT, ETHSS_SWITCH_PORT0, ETHSS_SWITCH_PORT1,
	       ETHSS_GMAC2_PORT, ETHSS_HPSW_PORTA, ETHSS_HPSW_PORTB}},

	{0x5, {ETHSS_GMAC0_PORT, ETHSS_SWITCH_PORT0, ETHSS_SWITCH_PORT1,
	       ETHSS_GMAC2_PORT, ETHSS_ESWM_PORT0, ETHSS_ESWM_PORT1}},

	{0x6, {ETHSS_MODCTRL_CONF_NONE, ETHSS_ETHERCAT_PORT0, ETHSS_ETHERCAT_PORT1,
	       ETHSS_GMAC2_PORT, ETHSS_ESWM_PORT0, ETHSS_ESWM_PORT1}},

	{0x7, {ETHSS_MODCTRL_CONF_NONE, ETHSS_GMAC0_PORT, ETHSS_GMAC1_PORT,
	       ETHSS_GMAC2_PORT, ETHSS_MODCTRL_CONF_NONE, ETHSS_MODCTRL_CONF_NONE}},

	{0x8, {ETHSS_GMAC0_PORT, ETHSS_SWITCH_PORT0, ETHSS_ETHERCAT_PORT1,
	       ETHSS_SWITCH_PORT2, ETHSS_GMAC1_PORT, ETHSS_GMAC2_PORT}},

	{0x9, {ETHSS_MODCTRL_CONF_NONE, ETHSS_MODCTRL_CONF_NONE, ETHSS_ETHERCAT_PORT1,
	       ETHSS_ETHERCAT_PORT2, ETHSS_GMAC1_PORT, ETHSS_GMAC2_PORT}}
};
...
static const char * const conf_to_string[] = {
	...
	[ETHSS_ESWM_PORT0]	= "ESWM_PORT0",
	[ETHSS_ESWM_PORT1]	= "ESWM_PORT1",
	[ETHSS_HPSW_PORTA]	= "HPSW_PORTA",
	[ETHSS_HPSW_PORTB]	= "HPSW_PORTB",
	[ETHSS_HPSW_PORTC]	= "HPSW_PORTC",
};
...
int ethss_gmac_ptp_timer(struct ethss *ethss, int gmac, int ethsw_timer)
{
	...
	if (ethsw_timer)
		ethss_reg_rmw(ethss, ETHSS_TMSEL, ETHSS_TMSEL_GMAC(gmac),
			      ETHSS_TMSEL_GMAC(gmac));
