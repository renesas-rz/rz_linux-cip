...
/*
 * Renesas R9A07G043F SoC Pin Controller and GPIO support
...
static const struct {
	...
	.pin_no_gpio = {
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 0,  TMS_SWDIO),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 1,  TDO_SWO),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 2,  AUDIO_CLK1),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 3,  AUDIO_CLK2),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 4,  SD0_CLK),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 5,  SD0_CMD),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 6,  SD0_RST_N),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 7,  SD0_DATA0),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 8,  SD0_DATA1),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 9,  SD0_DATA2),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 10, SD0_DATA3),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 11, SD0_DATA4),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 12, SD0_DATA5),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 13, SD0_DATA6),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 14, SD0_DATA7),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 15, SD1_CLK),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 16, SD1_CMD),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 17, SD1_DATA0),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 18, SD1_DATA1),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 19, SD1_DATA2),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 20, SD1_DATA3),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 21, QSPI0_SPCLK),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 22, QSPI0_IO0),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 23, QSPI0_IO1),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 24, QSPI0_IO2),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 25, QSPI0_IO3),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 26, QSPI0_SSL),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 27, QSPI_RESET_N),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 28, QSPI_WP_N),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 29, WDTOVF_PERROUT),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 30, RIIC0_SDA),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 31, RIIC0_SCL),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 32, RIIC1_SDA),
		RZ_G2L_PINCTRL_PIN_NO_GPIO(
			ARRAY_SIZE(r9a07g043f_pins.pin_gpio), 33, RIIC1_SCL),
	}
};
...
static int mtioc0a_b_pins[] = {
	/* MTIOC0A_B */
	RZ_G2L_PIN(7, 0),
};

static int mtioc0b_b_pins[] = {
	/* MTIOC0B_B */
	RZ_G2L_PIN(7, 1),
};

static int mtioc0c_b_pins[] = {
	/* MTIOC0C_B */
	RZ_G2L_PIN(7, 2),
};

static int mtioc0d_b_pins[] = {
	/* MTIOC0D_B */
	RZ_G2L_PIN(7, 3),
};

static int mtioc0a_c_pins[] = {
	/* MTIOC0A_C */
	RZ_G2L_PIN(3, 0),
};

static int mtioc0b_c_pins[] = {
	/* MTIOC0B_C */
	RZ_G2L_PIN(3, 1),
};

static int mtioc0c_c_pins[] = {
	/* MTIOC0C_C */
	RZ_G2L_PIN(3, 2),
};

static int mtioc0d_c_pins[] = {
	/* MTIOC0D_C */
	RZ_G2L_PIN(3, 3),
};

/* MTU channel 1 */
static int mtioc1a_a_pins[] = {
	/* MTIOC1A_A */
	RZ_G2L_PIN(1, 0),
};

static int mtioc1b_a_pins[] = {
	/* MTIOC1B_A */
	 RZ_G2L_PIN(1, 1),
};
...
/* MTU channel 2 */
static int mtioc2a_a_pins[] = {
	/* MTIOC2A_A */
	RZ_G2L_PIN(4, 0),
};

static int mtioc2b_a_pins[] = {
	/* MTIOC2B_A */
	RZ_G2L_PIN(4, 1),
};
...
/* MTU channel 3 */
static int mtioc3a_a_pins[] = {
	/* MTIOC3A_A */
	RZ_G2L_PIN(4, 2),
};

static int mtioc3b_a_pins[] = {
	/* MTIOC3B_A */
	RZ_G2L_PIN(4, 3),
};

static int mtioc3c_a_pins[] = {
	/* MTIOC3C_A */
	RZ_G2L_PIN(4, 4),
};

static int mtioc3d_a_pins[] = {
	/* MTIOC3D_A */
	RZ_G2L_PIN(4, 5),
};
...
static int mtioc4a_b_pins[] = {
	/* MTIOC4A_B */
	RZ_G2L_PIN(9, 0),
};

static int mtioc4b_b_pins[] = {
	/* MTIOC4B_B */
	RZ_G2L_PIN(9, 1),
};

static int mtioc4c_b_pins[] = {
	/* MTIOC4C_B */
	RZ_G2L_PIN(9, 2),
};

static int mtioc4d_b_pins[] = {
	/* MTIOC4D_B */
	RZ_G2L_PIN(9, 3),
};

/* MTU channel 5 */
static int mtic5u_a_pins[] = {
	/* MTIC5U_A */
	RZ_G2L_PIN(1, 2),
};

static int mtic5v_a_pins[] = {
	/* MTIC5V_A */
	RZ_G2L_PIN(1, 3),
};

static int mtic5w_a_pins[] = {
	/* MTIC5W_A */
	RZ_G2L_PIN(1, 4),
};
...
/* MTU channel 6 */
static int mtioc6a_pins[] = {
	/* MTIOC6A */
	RZ_G2L_PIN(10, 0),
};

static int mtioc6b_pins[] = {
	/* MTIOC6B */
	RZ_G2L_PIN(10, 1),
};

static int mtioc6c_pins[] = {
	/* MTIOC6C */
	RZ_G2L_PIN(10, 2),
};

static int mtioc6d_pins[] = {
	/* MTIOC6D */
	RZ_G2L_PIN(10, 3),
};
...
static int mtioc7a_c_pins[] = {
	/* MTIOC7A_C */
	RZ_G2L_PIN(8, 0),
};

static int mtioc7b_c_pins[] = {
	/* MTIOC7B_C */
	RZ_G2L_PIN(8, 1),
};

static int mtioc7c_c_pins[] = {
	/* MTIOC7C_C */
	RZ_G2L_PIN(8, 2),
};

static int mtioc7d_c_pins[] = {
	/* MTIOC7D_C */
	RZ_G2L_PIN(8, 3),
};
...
static struct group_desc r9a07g043f_groups[] = {
	...
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0a_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0b_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0c_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0d_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0a_c, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0b_c, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0c_c, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc0d_c, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc1a_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc1b_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc1a_c, 3),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc1b_c, 3),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc2a_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc2b_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc2a_c, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc2b_c, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc3a_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc3b_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc3c_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc3d_a, 4),
	...
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc4a_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc4b_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc4c_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc4d_b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtic5u_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtic5v_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtic5w_a, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtic5u_b, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtic5v_b, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtic5w_b, 4),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc6a, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc6b, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc6c, 5),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc6d, 5),
	...
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc7a_c, 6),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc7b_c, 6),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc7c_c, 6),
	RZ_G2L_PINCTRL_PIN_GROUP(mtioc7d_c, 6),
...
static const char *r9a07g043f_irq_groups[] = {
	"irq0_a", "irq0_b",
...
static const char *r9a07g043f_sci0_groups[] = {
	"sci0_data_a",
...
static const char *r9a07g043f_sci1_groups[] = {
...
static const char *r9a07g043f_scif0_groups[] = {
	"scif0_data",   "scif0_clk",   "scif0_ctrl",
	"scif0_data_b", "scif0_clk_b", "scif0_ctrl_b",
	"scif0_data_c",
};

static const char *r9a07g043f_scif1_groups[] = {
	"scif1_data",   "scif1_clk",   "scif1_ctrl",
	"scif1_data_b", "scif1_ctrl_b",
	"scif1_data_c",
};

static const char *r9a07g043f_scif2_groups[] = {
	"scif2_data_a", "scif2_clk_a", "scif2_ctrl_a",
	"scif2_data_b", "scif2_clk_b", "scif2_ctrl_b",
	"scif2_data_d", "scif2_clk_d", "scif2_ctrl_d",
};

static const char *r9a07g043f_scif3_groups[] = {
	"scif3_data",
	"scif3_data_b", "scif3_clk_b",
	"scif3_data_c", "scif3_clk_c",
};

static const char *r9a07g043f_scif4_groups[] = {
	"scif4_data_a", "scif4_clk_a",
	"scif4_data_b", "scif4_clk_b",
};

static const char *r9a07g043f_mtu0_groups[] = {
	"mtioc0a_a", "mtioc0b_a",
	"mtioc0a_b", "mtioc0b_b", "mtioc0c_b", "mtioc0d_b",
	"mtioc0a_c", "mtioc0b_c", "mtioc0c_c", "mtioc0d_c",
};

static const char *r9a07g043f_mtu1_groups[] = {
	"mtioc1a_a", "mtioc1b_a",
	"mtioc1a_c", "mtioc1b_c",
};

static const char *r9a07g043f_mtu2_groups[] = {
	"mtioc2a_a", "mtioc2b_a",
	"mtioc2a_c", "mtioc2b_c",
};

static const char *r9a07g043f_mtu3_groups[] = {
	"mtioc3a_a", "mtioc3b_a", "mtioc3c_a", "mtioc3d_a",
	"mtioc3a_b", "mtioc3b_b", "mtioc3c_b", "mtioc3d_b",
};

static const char *r9a07g043f_mtu4_groups[] = {
	"mtioc4a_a", "mtioc4b_a", "mtioc4c_a", "mtioc4d_a",
	"mtioc4a_b", "mtioc4b_b", "mtioc4c_b", "mtioc4d_b",
};

static const char *r9a07g043f_mtu5_groups[] = {
	"mtic5u_a", "mtic5v_a", "mtic5w_a",
	"mtic5u_b", "mtic5v_b", "mtic5w_b",
};

static const char *r9a07g043f_mtu6_groups[] = {
	"mtioc6a", "mtioc6b", "mtioc6c", "mtioc6d",
};

static const char *r9a07g043f_mtu7_groups[] = {
	"mtioc7a_a", "mtioc7b_a", "mtioc7c_a", "mtioc7d_a",
	"mtioc7a_b", "mtioc7b_b", "mtioc7c_b", "mtioc7d_b",
	"mtioc7a_c", "mtioc7b_c", "mtioc7c_c", "mtioc7d_c",
};

static const char *r9a07g043f_mtu8_groups[] = {
	"mtioc8a_a", "mtioc8b_a", "mtioc8c_a", "mtioc8d_a",
	"mtioc8a_b", "mtioc8b_b", "mtioc8c_b", "mtioc8d_b",
};

static const char *r9a07g043f_usb0_groups[] = {
	"usb0_a", "usb0_vbusen_a", "usb0_ovrcur_a",
	"usb0_otg_exicen_a", "usb0_otg_id_a",
};

static const char *r9a07g043f_usb1_groups[] = {
...
static const char *r9a07g043f_disp_groups[] = {
	"disp_clk", "disp_sync", "disp_de",
	"disp_bgr666", "disp_bgr888",
};

static const char *r9a07g043f_adc_groups[] = {
	"adc_a", "adc_b", "adc_c", "adc_d",
	"adc_e", "adc_f", "adc_g", "adc_h",
};

static const char *r9a07g043f_i2c2_groups[] = {
	"i2c2_b", "i2c2_c",
};

static const char *r9a07g043f_i2c3_groups[] = {
	"i2c3_b",
};

static const char *r9a07g043f_ssi0_groups[] = {
	"ssi0_data_a", "ssi0_ctrl_a",
	"ssi0_data_b", "ssi0_ctrl_b",
	"ssi0_data_d", "ssi0_ctrl_d",
};

static const char *r9a07g043f_ssi1_groups[] = {
	"ssi1_data_a", "ssi1_ctrl_a",
	"ssi1_data_b", "ssi1_ctrl_b",
	"ssi1_data_c", "ssi1_ctrl_c",
};

static const char *r9a07g043f_ssi2_groups[] = {
	"ssi2_data_a", "ssi2_ctrl_a",
	"ssi2_data_b", "ssi2_ctrl_b",
};

static const char *r9a07g043f_ssi3_groups[] = {
	"ssi3_data", "ssi3_ctrl",
};

static const char *r9a07g043f_rspi0_groups[] = {
...
static const char *r9a07g043f_can1_groups[] = {
	"can1_tx_b", "can1_rx_b",
...
static const char *r9a07g043f_poe_groups[] = {
	"poe_b", "poe_c",
};

static const char *r9a07g043f_sdhi0_groups[] = {
	"sdhi0_cd_a", "sdhi0_wp_a",
};

static const char *r9a07g043f_sdhi1_groups[] = {
	"sdhi1_cd_b", "sdhi1_wp_b",
};

static const char *r9a07g043f_mtclk_groups[] = {
	"mtclka_b", "mtclkb_b", "mtclkc_b", "mtclkd_b",
};

static const char *r9a07g043f_eth0_groups[] = {
	"eth0_link", "eth0_mdio", "eth0_mii", "eth0_rgmii",
};

static const char *r9a07g043f_eth1_groups[] = {
	"eth1_link", "eth1_mdio", "eth1_mii", "eth1_rgmii",
};

static const struct function_desc r9a07g043f_funcs[] = {
	{"irq", r9a07g043f_irq_groups,
		ARRAY_SIZE(r9a07g043f_irq_groups)},
	{"sci0", r9a07g043f_sci0_groups,
		ARRAY_SIZE(r9a07g043f_sci0_groups)},
	{"sci1", r9a07g043f_sci1_groups,
		ARRAY_SIZE(r9a07g043f_sci1_groups)},
	{"scif0", r9a07g043f_scif0_groups,
		ARRAY_SIZE(r9a07g043f_scif0_groups)},
	{"scif1", r9a07g043f_scif1_groups,
		ARRAY_SIZE(r9a07g043f_scif1_groups)},
	{"scif2", r9a07g043f_scif2_groups,
		ARRAY_SIZE(r9a07g043f_scif2_groups)},
	{"scif3", r9a07g043f_scif3_groups,
		ARRAY_SIZE(r9a07g043f_scif3_groups)},
	{"scif4", r9a07g043f_scif4_groups,
		ARRAY_SIZE(r9a07g043f_scif4_groups)},
	{"mtu0", r9a07g043f_mtu0_groups,
		ARRAY_SIZE(r9a07g043f_mtu0_groups)},
	{"mtu1", r9a07g043f_mtu1_groups,
		ARRAY_SIZE(r9a07g043f_mtu1_groups)},
	{"mtu2", r9a07g043f_mtu2_groups,
		ARRAY_SIZE(r9a07g043f_mtu2_groups)},
	{"mtu3", r9a07g043f_mtu3_groups,
		ARRAY_SIZE(r9a07g043f_mtu3_groups)},
	{"mtu4", r9a07g043f_mtu4_groups,
		ARRAY_SIZE(r9a07g043f_mtu4_groups)},
	{"mtu5", r9a07g043f_mtu5_groups,
		ARRAY_SIZE(r9a07g043f_mtu5_groups)},
	{"mtu6", r9a07g043f_mtu6_groups,
		ARRAY_SIZE(r9a07g043f_mtu6_groups)},
	{"mtu7", r9a07g043f_mtu7_groups,
		ARRAY_SIZE(r9a07g043f_mtu7_groups)},
	{"mtu8", r9a07g043f_mtu8_groups,
		ARRAY_SIZE(r9a07g043f_mtu8_groups)},
	{"usb0", r9a07g043f_usb0_groups,
		ARRAY_SIZE(r9a07g043f_usb0_groups)},
	{"usb1", r9a07g043f_usb1_groups,
		ARRAY_SIZE(r9a07g043f_usb1_groups)},
	{"disp", r9a07g043f_disp_groups,
		ARRAY_SIZE(r9a07g043f_disp_groups)},
	{"adc", r9a07g043f_adc_groups,
		ARRAY_SIZE(r9a07g043f_adc_groups)},
	{"i2c2", r9a07g043f_i2c2_groups,
		ARRAY_SIZE(r9a07g043f_i2c2_groups)},
	{"i2c3", r9a07g043f_i2c3_groups,
		ARRAY_SIZE(r9a07g043f_i2c2_groups)},
	{"ssi0", r9a07g043f_ssi0_groups,
		ARRAY_SIZE(r9a07g043f_ssi0_groups)},
	{"ssi1", r9a07g043f_ssi1_groups,
		ARRAY_SIZE(r9a07g043f_ssi1_groups)},
	{"ssi2", r9a07g043f_ssi2_groups,
		ARRAY_SIZE(r9a07g043f_ssi2_groups)},
	{"ssi3", r9a07g043f_ssi3_groups,
		ARRAY_SIZE(r9a07g043f_ssi3_groups)},
	{"rspi0", r9a07g043f_rspi0_groups,
		ARRAY_SIZE(r9a07g043f_rspi0_groups)},
	{"rspi1", r9a07g043f_rspi1_groups,
		ARRAY_SIZE(r9a07g043f_rspi1_groups)},
	{"rspi2", r9a07g043f_rspi2_groups,
		ARRAY_SIZE(r9a07g043f_rspi2_groups)},
	{"can_clk", r9a07g043f_can_clk_groups,
		ARRAY_SIZE(r9a07g043f_can_clk_groups)},
	{"can0", r9a07g043f_can0_groups,
		ARRAY_SIZE(r9a07g043f_can0_groups)},
	{"can1", r9a07g043f_can1_groups,
		ARRAY_SIZE(r9a07g043f_can1_groups)},
	{"poe", r9a07g043f_poe_groups,
		ARRAY_SIZE(r9a07g043f_poe_groups)},
	{"sdhi0", r9a07g043f_sdhi0_groups,
		ARRAY_SIZE(r9a07g043f_sdhi0_groups)},
	{"sdhi1", r9a07g043f_sdhi1_groups,
		ARRAY_SIZE(r9a07g043f_sdhi1_groups)},
	{"mtclk", r9a07g043f_mtclk_groups,
		ARRAY_SIZE(r9a07g043f_mtclk_groups)},
	{"eth0", r9a07g043f_eth0_groups,
		ARRAY_SIZE(r9a07g043f_eth0_groups)},
	{"eth1", r9a07g043f_eth1_groups,
		ARRAY_SIZE(r9a07g043f_eth1_groups)},
};

/* R9A07G043F support 82 interrupt input pins */
static struct rzg2l_pin_info r9a07g043f_pin_info[] = {
...
const struct rzg2l_pin_soc r9a07g043f_pinctrl_data = {
	.pins =	r9a07g043f_pins.pin_gpio,
	.npins = ARRAY_SIZE(r9a07g043f_pins.pin_gpio) +
		 ARRAY_SIZE(r9a07g043f_pins.pin_no_gpio),
	.groups	= r9a07g043f_groups,
	.ngroups = ARRAY_SIZE(r9a07g043f_groups),
	.funcs = r9a07g043f_funcs,
	.nfuncs	= ARRAY_SIZE(r9a07g043f_funcs),
	.nports = 19,
	.nirqs = 32,
	.pin_info = r9a07g043f_pin_info,
	.ngpioints = ARRAY_SIZE(r9a07g043f_pin_info),
};
