		...
		if (poeg_np != NULL) {
			...
			if (poeg_dev_np) {
				...
				if (strcmp(poeg_np->name, "poega") == 0) {
					...
					rzg2l_gpt_Z_phases[j] = "GTETRGA";
					Z_phase_mode_set[j] = Z_phase_mode_set_A;
					...
					rzg2l_gpt_Z_phases[j] = "GTETRGB";
					Z_phase_mode_set[j] = Z_phase_mode_set_B;
					...
					rzg2l_gpt_Z_phases[j] = "GTETRGC";
					Z_phase_mode_set[j] = Z_phase_mode_set_C;
					...
					rzg2l_gpt_Z_phases[j] = "GTETRGD";
					Z_phase_mode_set[j] = Z_phase_mode_set_D;
