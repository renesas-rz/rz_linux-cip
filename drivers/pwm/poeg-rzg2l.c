...
static const struct rz_poeg_data_cfg rzt2_cfg = {
...
static const struct of_device_id rzg2l_poeg_of_table[] = {
	...
	{ .compatible = "renesas,poeg-r9a07g076", .data = &rzt2_cfg, },
	{ },
};
