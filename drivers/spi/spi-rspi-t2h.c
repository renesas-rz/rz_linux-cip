...
/*
 *functions for RSPI on T2H
 */
static int rspi_t2h_set_config_register(struct rspi_data *rspi, int access_size)
{
...
static void rspi_t2h_receive_init(const struct rspi_data *rspi)
{
...
static int rspi_t2h_transfer_one(struct spi_controller *ctlr,
				struct spi_device *spi,
				struct spi_transfer *xfer)
{
	struct rspi_data *rspi = spi_controller_get_devdata(ctlr);

	rspi_t2h_receive_init(rspi);
...
static const struct spi_ops rspi_t2h_ops = {
	.set_config_register	=	rspi_t2h_set_config_register,
	.transfer_one		=	rspi_t2h_transfer_one,
	.min_div		=	2,
	.max_div		=	4096,
	.flags			=	SPI_CONTROLLER_MUST_RX | SPI_CONTROLLER_MUST_TX,
	.fifo_size		=	4,	/* 4 for TX, 4 for RX */
	.num_hw_ss		=	1,
};
...
static const struct platform_device_id spi_driver_ids[] = {
	{ "rspi", (kernel_ulong_t)&rspi_t2h_ops },
	{},
};
